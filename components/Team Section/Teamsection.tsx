...
const teamMembers = [
  { name: "John Smith", des: "Designation here", image: Teamcard1 },
  { name: "Elina Williams", des: "Designation here", image: Teamcard2 },
  { name: "John Smith", des: "Designation here", image: Teamcard3 },
];
